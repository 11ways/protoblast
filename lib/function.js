module.exports = function BlastFunction(Blast, Collection) {
	...
	tokenPatterns = {
		whitespace : /\s+/,
		keyword    : /\b(?:var|let|for|if|else|in|class|function|typeof|return|with|case|break|switch|export|new|while|do|throw|catch|true|false|continue|null|undefined)\b/,
