module.exports = function BlastFunction(Blast, Collection) {
	...
	Blast.ready(function() {
		match = Collection.RegExp.combine.apply(null, Collection.Object.values(pattern));
	});

	/**
	 * Convert this function to tokens
	 *
	 * @author   Jelle De Loecker   <jelle@codedor.be>
	 * @since    0.1.2
	 * @version  0.1.2
	 ...
	 * @return   {Array}
	 */
	Blast.definePrototype('Function', 'tokenize', function tokenize(throwErrors) {

		var sourceCode = ''+this,
		    tokens     = [];

		return sourceCode.split(match).filter(function(e, i) {
