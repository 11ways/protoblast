...
function createMutableClass(parent, constructor) {

	const result = Fn.inherits('Develry.Decimal', constructor);
...
const MutableDecimal = createMutableClass(Decimal, function MutableDecimal(value) {
	...
	MutableDecimal.super.call(this, value);
});
...
Decimal.setMethod(function toScale(scale) {
	...
	return this.returnArithmeticResult(this_unified, original_scale, scale);
});
...
Decimal.setMethod(function toMutable() {
	...
	let result = Object.create(MutableDecimal.prototype);
	copySettings(result, this);
