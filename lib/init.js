	...
	Blast.getClientPath = function getClientPath(options) {
		...
		Blast.Bound.Function.parallel(tasks, function gotFiles(err, files) {
			...
			if (create_source_map) {
				...
				let sourcemap_64 = new Buffer(sourcemap.toString()).toString('base64');
				let inline_source_map = '//# sourceMappingURL=data:application/json;charset=utf-8;base64,' + sourcemap_64;
