module.exports = function BlastInit(modifyPrototype) {
	...
	Blast.getClientPath = function getClientPath() {
		...
		// All these files will be registered
		files = ['init', 'array', 'date', 'function', 'object', 'string', 'regexp', 'number', 'inflections', 'diacritics'];
	...
	require('./regexp.js')(Blast, Collection);
	require('./date.js')(Blast, Collection);
	require('./array.js')(Blast, Collection);
	require('./number.js')(Blast, Collection);
