module.exports = function BlastInit(modifyPrototype) {
	...
	Blast.getClientPath = function getClientPath(useCommon) {
		...
		files = ['init', 'inflections', 'diacritics', 'function_flow', 'benchmark', 'informer', 'misc', 'string_entities', 'setimmediate', 'sorting'].concat(Names);
	...
	require('./informer.js')(Blast, Collection);
