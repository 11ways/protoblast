module.exports = function BlastInit(modifyPrototype) {
	 ...
	 * @version   0.1.3
	 */
	Blast.inherits = function inherits(constructor, superConstructor) {

		// Store the parent constructor
	...
	Blast.getClientPath = function getClientPath(useCommon) {
		...
		files = ['init', 'inflections', 'diacritics', 'function_flow', 'benchmark', 'misc', 'string_entities', 'setimmediate', 'sorting'].concat(Names);
