module.exports = function BlastArray(Blast, Collection) {
	 ...
	 * @param    {Function}  fnc    The function to apply to
	 *
	 * @return   {Array}
	 */
	Blast.definePrototype('Array', 'employ', function employ(args, fnc) {
