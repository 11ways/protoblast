module.exports = function BlastDeck(Blast, Collection) {
	 ...
	 * @return   {Object}
	 */
	Blast.defineValue(Deck.prototype, 'toDry', function toDry() {
	 ...
	 * @return   {Boolean}
	 */
	Blast.defineValue(Deck.prototype, 'has', function has(key) {
	 ...
	 * @return   {Mixed}
	 */
	Blast.defineValue(Deck.prototype, 'get', function get(key, def) {
	 ...
	 * @return   {Array}
	 */
	Blast.defineValue(Deck.prototype, 'getSorted', function getSorted(slice) {
	 ...
	 * @return   {Array}
	 */
	Blast.defineValue(Deck.prototype, 'getSortedItems', function getSortedItems(slice) {
	 ...
	 * @return   {Deck}
	 */
	Blast.defineValue(Deck.prototype, 'clone', function clone() {
