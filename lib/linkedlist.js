...
/**
 * Iterate ove rthe list and apply the callback to each item
 *
 * @author   Jelle De Loecker   <jelle@elevenways.be>
 * @since    0.8.16
 * @version  0.8.16
...
LinkedList.setMethod(function unshift(...values) {
	...
	for (i = 0; i < values.length; i++) {
		node = new Node(values[i], this[HEAD]);
...
LinkedList.setMethod(function push(...values) {
	...
	for (i = 0; i < values.length; i++) {
		node = new Node(values[i], null, this[TAIL]);
...
LinkedMap.setMethod(['push', 'set'], function set(key, value) {
	...
	let node = new KeyedNode(key, value, null, this[TAIL]);
...
LinkedMap.setMethod(function unshift(key, value) {
	...
	let node = new KeyedNode(key, value, this[HEAD]);
...
LinkedMap.setMethod(function setBefore(existing_key, new_key, value) {
	...
	let node = new KeyedNode(new_key, value, existing, existing.prev);
...
LinkedMap.setMethod(function setAfter(existing_key, new_key, value) {
	...
	let node = new KeyedNode(new_key, value, existing.next, existing);
 ...
 * @version  0.8.16
 */
const BaseNode = Fn.inherits(null, 'Develry', function BaseLinkedNode(value, next = null, prev = null) {
	this[VALUE] = value;
	this[NEXT] = next;
	this[PREV] = prev;
});
 ...
 * @version  0.8.16
 */
const KeyedNode = Fn.inherits(BaseNode, function KeyedNode(key, value, next = null, prev = null) {
	this[KEY] = key;
	this[VALUE] = value;
	this[NEXT] = next;
	this[PREV] = prev;
