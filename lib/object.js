module.exports = function BlastObject(Blast, Collection) {
	...
	Blast.defineStatic('Object', 'isPrimitive', function isPrimitive(arg) {
		...
		if (arg == 'string' || arg == 'number' || arg == 'boolean') {
			return true;
		}
	...
	Blast.defineStatic('Object', 'hasProperty', function hasProperty(target, property) {
		...
		if (target == null || (typeof target[property] === 'undefined' && !(property in target))) {
			return false;
		}
	 ...
	 * @return    {String}
	 */
	Blast.defineStatic('Object', 'checksum', function checksum(obj) {
