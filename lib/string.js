 ...
 * @return   {String}
 */
defStat('serializeAttributes', function serializeAttributes(obj) {
 ...
 * @return   {String}
 */
defStat('randomMac', function randomMac(prefix) {
 ...
 * @return   {String}
 */
defProto('escapeUnicode', function escapeUnicode() {
 ...
 * @return   {String}   The truncated string
 */
defProto(function truncateHTML(length, word, ellipsis) {
 ...
 */
defProto(function replaceAll(needle, replacement) {
...
defProto(function checksum(start, end) {
	...
	let result = checksum_cache.get(key);
 ...
 * @return   {String}
 */
defProto(function normalizeAcronyms() {
