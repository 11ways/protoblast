module.exports = function BlastString(Blast, Collection, Bound, Obj) {
	...
	var astral_rx = /\ud83c[\udffb-\udfff](?=\ud83c[\udffb-\udfff])|(?:[^\ud800-\udfff][\u0300-\u036f\ufe20-\ufe23\u20d0-\u20f0]?|[\u0300-\u036f\ufe20-\ufe23\u20d0-\u20f0]|(?:\ud83c[\udde6-\uddff]){2}|[\ud800-\udbff][\udc00-\udfff]|[\ud800-\udfff])[\ufe0e\ufe0f]?(?:[\u0300-\u036f\ufe20-\ufe23\u20d0-\u20f0]|\ud83c[\udffb-\udfff])?(?:\u200d(?:[^\ud800-\udfff]|(?:\ud83c[\udde6-\uddff]){2}|[\ud800-\udbff][\udc00-\udfff])[\ufe0e\ufe0f]?(?:[\u0300-\u036f\ufe20-\ufe23\u20d0-\u20f0]|\ud83c[\udffb-\udfff])?)*/g,
	    hashLengths = {
		'md5': 32,
		'sha1': 40
	};
	...
	Blast.definePrototype('String', function stripTags(allowed_tags, tag_replacement) {
		...
		// Tokenize the input
		tokens = Blast.Bound.String.tokenizeHTML(this);
	...
	Blast.definePrototype('String', function truncateHTML(length, word, ellipsis) {
		...
		temp = this.substrCharacters(0, length).match(/<(\/?)(.*?)>/g);
	...
	Blast.definePrototype('String', function count(word) {
		...
		if (word == null || word === '') {
			return Blast.Bound.String.countCharacters(this);
		}
