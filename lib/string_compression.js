module.exports = function BlastCompression(Blast, Collection) {
	...
	Blast.defineStatic('String', 'compressToBase64', function compressToBase64(input) {
		...
		return Collection.String.convertToBase64(Collection.String.compress(input));
	});

	/**
	 * Convert a string to Base64, even non latin-8 ones
	 *
	 * @author   Pieroxy <pieroxy@pieroxy.net>
	 * @author   Jelle De Loecker   <jelle@codedor.be>
	 * @since    0.1.4
	 ...
	 * @return   {String}
	 */
	Blast.defineStatic('String', 'convertToBase64', function convertToBase64(input) {
	...
	Blast.defineStatic('String', 'decompressFromBase64', function decompressFromBase64(input) {
		...
		return Collection.String.decompress(Collection.String.convertFromBase64(input));
	});
	 ...
	 * @return   {String}
	 */
	Blast.defineStatic('String', 'convertFromBase64', function convertFromBase64(input) {
